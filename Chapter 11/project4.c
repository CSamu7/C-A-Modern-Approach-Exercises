...
void analyze_hand(int hand[NUM_CARDS][2], bool *straight, bool *flush, bool *four, bool *three, bool *royal_flush, bool *ace_straight, int *pairs);
void print_result(bool *straight, bool *flush, bool *four, bool *three, bool *royal_flush, bool *ace_straight, int *pairs);
...
int main(void){
	...
	while(true){
		read_cards(hand);
		analyze_hand(hand, &straight, &flush, &four, &three, &royal_flush, &ace_straight, &pairs);
		print_result(&straight, &flush, &four, &three, &royal_flush, &ace_straight, &pairs);
	}
}
